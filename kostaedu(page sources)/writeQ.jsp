...
<body class="host_version"> 
    ...
    <form action="../question/write" method="post">
       <table class="table">
          <tr>
             <th><font size="10px">Question</font> <br><input type="text" name="qtitle" id="qtitle" placeholder="Type the Title"></th>
              <th><font size="5px">Lecture : </font><input type="text" name="qlect" id="qlect" placeholder="Type related lecture"></th>
             </tr>
       </table>
       <hr>
       <div align="center" id="details">
               <!-- <input type="text" name="qcontent" id="qcontent"> -->
               <textarea name="qcontent" required wrap="hard" placeholder="Enter"></textarea><br><br>
