...
<% ArrayList<String> snt = (ArrayList<String>)session.getAttribute("notdet"); %>
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="Registration">
							<form action="../people/regis" method="post" role="form"
								...
								<div class="form-group">
									<div class="col-sm-12">
										<Select name="regsel" class="form-control">
	...
	<div id="overviews" class="section wb">
		<div class="container">
			...
			<div>
				<table class="table">
					<tr>
						<th>Title: &nbsp;&nbsp;&nbsp; <%=snt.get(0) %></th>
						<!-- title - db access -->
						<th>Date: &nbsp;&nbsp;&nbsp; <%=snt.get(1) %></th>
						<!-- uldate - db access -->
					</tr>
				</table>
				<div>
					<pre id="pre"><%=snt.get(2) %></pre>
					<!-- <pre> area - db access -->
				</div>
				<br>
				<div>
					<button id="but1">뒤로</button>
					<!-- js add -->
