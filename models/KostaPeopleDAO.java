...
public class KostaPeopleDAO {
	...
	public KostaPeopleDAO() {
//		try {
//			if(conn==null)
//				conn=ConnectionHelper.getConn();
//			System.out.println("KostaPeople Connection Success");
...
//		}
	...
	public int update(String id, String pwd) throws SQLException{ // id : from session // pwd : from a user -- password를 바꾸는 모듈에 사용 
		conn=ConnectionHelper.getConn();
		int ret;
	...
	public int delete(String id, String pwd) throws SQLException{ // id, password : from session // if ret==0 -> alert to user
		conn=ConnectionHelper.getConn();
		int ret = 0;
